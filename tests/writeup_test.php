 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignfeedback_writeup_testcase extends advanced_testcase {

    // Use the generator helper.
    use mod_assign_test_generator;

    /**
     * Test the is_feedback_modified() method for the writeup feedback.
     */
    public function test_is_feedback_modified() {
        ...
        $assign = $this->create_instance($course, [
                ...
                'assignfeedback_writeup_enabled' => 1,
            ]);
        ...
        // Change the data.
        $data->assignfeedbackwriteup_editor = [
